...
data class UserPreferences(
    ...
    // Export Settings
    val defaultExportFormat: com.cosmiclaboratory.voyager.domain.model.enums.ExportFormat = com.cosmiclaboratory.voyager.domain.model.enums.ExportFormat.VOYAGER_JSON,
    ...
    val enabledGeocodingProviders: Set<String> = setOf("android_geocoder", "nominatim", "overpass", "photon"),
    val geocodingApiKeys: Map<String, String> = emptyMap(), // Provider ID -> API key
    ...
    // F-33: Configurable semantic time ranges (previously hardcoded in LocationTrackingService)
    val workHoursStart: Int = 9,    // Work hours start (0-23)
    val workHoursEnd: Int = 17,     // Work hours end (0-23)
    val commuteHoursStart: Int = 7, // Morning commute start (0-23)
    val commuteHoursEnd: Int = 9,   // Morning commute end (0-23)
    val commuteEveningStart: Int = 17, // Evening commute start (0-23)
    val commuteEveningEnd: Int = 19    // Evening commute end (0-23)
)
...
fun UserPreferences.validated(): UserPreferences {
    return copy(
        ...
        // Semantic Time Range Validation (F-33)
        workHoursStart = workHoursStart.coerceIn(0, 23),
        workHoursEnd = workHoursEnd.coerceIn(0, 23),
        commuteHoursStart = commuteHoursStart.coerceIn(0, 23),
        commuteHoursEnd = commuteHoursEnd.coerceIn(0, 23),
        commuteEveningStart = commuteEveningStart.coerceIn(0, 23),
        commuteEveningEnd = commuteEveningEnd.coerceIn(0, 23)
    )
}