...
/**
 * First-launch Google Timeline import step — the migration wedge for users moving
 * from Google Maps Timeline. Offered once (see [GoogleTimelineImportPreferences]),
 * after the restore step and before permissions. Importing or skipping both call
 * [onComplete].
 */
@Composable
fun GoogleTimelineImportScreen(
    viewModel: GoogleTimelineImportViewModel = hiltViewModel(),
    onComplete: () -> Unit = {}
) {
    ...
    Column(
        ...
        Text(
            text = "Bring your Google Timeline",
        ...
        Text(
            text = "Switching from Google Maps Timeline? Import your places and trips. " +
