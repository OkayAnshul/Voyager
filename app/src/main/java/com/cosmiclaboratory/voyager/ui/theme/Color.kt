...
// ============================================================================
// BACKWARD COMPATIBILITY ALIASES → VoyagerColors
// ============================================================================
// These allow existing code referencing Teal/TealDim to keep working during migration.
// Do not remove the original definitions above — they are still used by MatrixDarkColorScheme
// and other legacy references.